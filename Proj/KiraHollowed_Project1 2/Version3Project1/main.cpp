 ...
 * Created on February 2, 2022, 3:56 PM
 * Purpose: Project 1 Version 3, Battleship Game
 */
...
int main()
{
	...
	for (int aplyr=1; aplyr<3; ++aplyr)
	{
		...
		for (int ship1=0; ship1<type; ++ship1)
		{
			...
			//Give instructions
			cout << "\n";
			cout << "INSTRUCTIONS (Player " << aplyr << endl;
			cout << "Ship Type: " << ship[ship1].name << " has a length of " << ship[ship1].length  <<endl;
			cout << "Place ship";
