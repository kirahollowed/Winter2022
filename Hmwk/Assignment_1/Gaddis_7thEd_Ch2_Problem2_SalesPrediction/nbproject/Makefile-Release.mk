...
.NO_PARALLEL:${OBJECTDIR}/problem\ 2.o
${OBJECTDIR}/problem\ 2.o: problem\ 2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/problem\ 2.o problem\ 2.cpp
